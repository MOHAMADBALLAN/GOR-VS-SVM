# -*- coding: utf-8 -*-
"""
Created on Mon Oct 22 15:51:12 2018
...
for i in l :
    if len(i)<2:
        p=open("/home/um52/project/fasta2/pro/"+i[0]+".fasta.txt") # sequnces profiles for the proteins in our training dataset
        ss=open("/home/um52/project/fasta2/dssp/" + i[0] +".dssp") # secondry structure conformatons sequnces for the proteins in our training dataset
    else:
...
pickle.dump (mySVC, gzip.open("/home/um52/project/fasta2/m/3/modelB_.pkl.gz",'w')) #save the model
