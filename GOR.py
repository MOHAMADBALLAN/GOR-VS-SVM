# -*- coding: utf-8 -*-
"""
Created on Sun Oct 14 16:00:40 2018
...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 11 17:26:14 2018
...
ids=open("/home/um52/project/fasta2/T3/CV3") # the ids of training data 
l=[]
for lines in ids :
...
for i in l :
    if len(i)<2:
        p=open("/home/um52/project/fasta2/pro/"+i[0]+".fasta.txt") # sequnces profiles of our training dataset files
        ss=open("/home/um52/project/fasta2/dssp/" + i[0] +".dssp") # secondry structure conformations sequnces from dssp files
    else:
        p=open("/home/um52/project/fasta2/pro/"+i[0]+"."+i[1]+".txt")
        ss=open("/home/um52/project/fasta2/dssp/" + i[0]+"."+i[1] +".dssp")
...
N=[]
A=[]
ids2=open("/home/um52/project/fasta2/T3/test3")  # the ids of the blind/test dataset 
...
for i in l :
    if len(i)<2:
        pro=open("/home/um52/project/fasta2/pro/"+i[0]+".fasta.txt") # sequnces profiles of our testing  dataset files
      
    else:
        pro=open("/home/um52/project/fasta2/pro/"+i[0]+"."+i[1]+".txt")
